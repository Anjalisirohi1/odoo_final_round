    ...
    <header className="sticky top-0 z-50 border-b border-slate-200/90 bg-white/95 backdrop-blur-md shadow-xs">
      ...
      <div className="mx-auto flex h-16 w-full max-w-[1600px] items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3.5">
          ...
          <div className="hidden sm:inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white px-3 py-1 text-xs font-medium text-slate-600 shadow-xs">
      ...
      <nav aria-label="Global Module Navigation" className="border-t border-slate-100 bg-slate-50/90 px-4 sm:px-6 lg:px-8 overflow-x-auto scrollbar-none">
        <div className="mx-auto flex max-w-[1600px] items-center space-x-1 py-1.5 min-w-max">
          <a aria-current="page" className="inline-flex items-center gap-1.5 rounded-lg bg-white px-3.5 py-1.5 text-xs font-bold text-brand-700 shadow-sm ring-1 ring-slate-200/80 transition" href="#">
          ...
          <a className="inline-flex items-center rounded-md px-3 py-1.5 text-xs font-medium text-slate-600 hover:bg-white/80 hover:text-slate-900 transition" href="#">Quotations</a>
